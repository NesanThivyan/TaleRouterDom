import img1 from "../assets/images/faqs-image.jpg";
import img2 from "../assets/images/services-01.jpg";
import img3 from "../assets/images/services-02.jpg";
import img4 from "../assets/images/services-03.jpg";
import img5 from "../assets/images/services-04.jpg";
                        ...
                        <div className="steps">
                            <div className="row">
                                <div className="col-lg-3">
                                    <div className="item">
                                        <img src={img2} alt="" style={{ maxWidth: "66px", borderRadius: "50%", margin: "0 auto" }} />
                                        <h4>Project Introduction</h4>
                                    </div>
                                </div>
                                <div className="col-lg-3">
                                    <div className="item">
                                        <img src={img3} alt="" style={{ maxWidth: "66px", borderRadius: "50%", margin: "0 auto" }} />
                                        <h4>Work Development</h4>
                                    </div>
                                </div>
                                <div className="col-lg-3">
                                    <div className="item">
                                        <img src={img4} alt="" style={{ maxWidth: "66px", borderRadius: "50%", margin: "0 auto" }} />
                                        <h4>Data Analysis</h4>
                                    </div>
                                </div>
                                <div className="col-lg-3">
                                    <div className="item last-item">
                                        <img src={img5} alt="" style={{ maxWidth: "66px", borderRadius: "50%", margin: "0 auto" }} />
        ...
        <footer>
            <div className="container">
              <div className="col-lg-12">
                ...
                <br />Design: <a href="https://templatemo.com" target="_blank" rel="noopener noreferrer">TemplateMo</a></p>
              </div>
            </div>
        </footer>
        </>
